...
Route::prefix('pos-terminal')->name('pos-terminal.')->middleware(['auth', 'role:super-admin,admin,cashier'])->group(function () {
...
Route::prefix('user-management')->name('user-management.')->middleware(['auth', 'role:super-admin,admin'])->group(function () {
...
Route::prefix('product-management')->name('product-management.')->middleware(['auth', 'role:super-admin,admin'])->group(function () {
...
Route::prefix('stock-management')->name('stock-management.')->middleware(['auth', 'role:super-admin,admin'])->group(function () {
...
Route::prefix('reporting')->name('reporting.')->middleware(['auth', 'role:super-admin,admin,cashier'])->group(function () {
...
// Chatbot - accessible by all authenticated users
Route::prefix('chatbot')->name('chatbot.')->middleware(['auth', 'role:super-admin,admin'])->group(function () {
